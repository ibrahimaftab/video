class PlayerBar extends HTMLElement {
  ...
  toogleFullscreen = document.createElement("toggle-screen");
  setting = document.createElement("setting");
  ...
  async connectedCallback() {
    ...
    this.play.addEventListener("click", function () {
      triggerEvent(evts.default.playPause, self.parentElement);
    });

    this.toogleFullscreen.addEventListener("click", function () {
      triggerEvent(evts.default.toggleFullScreen, self.parentElement);
    });
    ...
    this.parentElement.addEventListener(evts.default.playable, function () {
      ...
      self.append(self.play, timeline, self.setting, self.toogleFullscreen);
      ...
      const { video } = self.parentElement;
        ...
        elm.addEventListener("click", function () {
          const playback =
            elm.textContent === "Normal"
              ? self.parentElement.video.defaultPlaybackRate
              : Number(elm.textContent);
          self.parentElement.video.playbackRate = playback;
          self.dropdown
